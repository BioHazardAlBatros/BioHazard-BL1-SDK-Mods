...
oidLegendaryPearlsOnly = BoolOption(
    "Legendaries and Pearls Only",
    False,
    "On",
    "Off",
    description="With this enabled, only legendaries and pearls will have lights. Otherwise every other allowed item will have a light.",
)
...
def EnableLight(Pickupable:UObject):
    ...
    if oidLegendaryPearlsOnly.value and Pickupable.InventoryRarityLevel < 50:
        return
